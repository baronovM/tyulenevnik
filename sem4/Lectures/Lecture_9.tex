...
\end{proof}
\subsection{Дифференцирование несобственного интеграла по параметру.}
\begin{theorem}
...
\subsection{Равномерная сходимость интегралов по параметру.}
...
\end{proof}
\begin{theorem}[Признак Вейерштрасса] % аккуратно переформулировать
...
\begin{theorem}[Критерий Коши]
    ...
    \begin{itemize}
        ...
        \]
    \end{itemize}
\end{theorem} % Чуток поправить потом как-нибудь.
\begin{proof}
