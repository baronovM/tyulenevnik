...
Тогда $\mathcal{F}[f](x) := \operatorname{V.P.}\frac{1}{\sqrt{2\pi}} \int\limits_{\mathbb{R}} e^{-ixy} \, f(y) \, dy, \quad x \in \mathbb{R}.$
\end{definition}
...
\[
\mathcal{F}^{-1} \left[ f \right](x) := \operatorname{V.P.} \frac{1}{\sqrt{2 \pi}} \int\limits_{\mathbb{R}} e^{ixy} f(y) \, dy
\]
