...
\begin{definition}
    ...
    \]
    То есть $x = \sum\limits_{k=1}^{\infty} \alpha_k(x) e_k$. Из единсвтенности в определнии следует линейная лезависимость системы векторов.
\end{definition}
...
\begin{note}
    (От редакторов) Эту теорему более наглядной делает ее более простая версия, без компелксных экспонент, а с тригонометрическими функциями, тогда мы понимаем что $y=\omega$ это "частота колебаний" нашего синуса:
