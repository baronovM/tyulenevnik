...
\begin{equation}
	\notag
	I_{n}:=\int\limits_{0}^{\delta}\frac{\sin(nu)}{u}\bigg[f(x_{0}+u)-f(x_0+0)\bigg]\,du \to 0, \quad n \to \infty.
\end{equation}
...
\begin{equation}
	\notag
	I^{1}_{n}:=\int\limits_{0}^{\delta(\varepsilon)}\frac{\sin(nu)}{u}[f(x_{0}+u)-f(x_0+0)]\,du =
	[f(x_{0}+\delta)-f(x_0+0)]\int\limits_{\xi}^{\delta(\varepsilon)}\frac{\sin(nu)}{u}\,du.
\end{equation}
...
\begin{equation}
	\notag
	|I_{n}^{2}|:=\Bigl|\int\limits_{\delta(\varepsilon)}^{\delta}\frac{\sin(nu)}{u}[f(x_{0}+u)-f(x_0+0)]\,du\Bigr| < \varepsilon/2.
\end{equation}
